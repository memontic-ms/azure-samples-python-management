...
def __update_communication_service(args):
    ...
    if args.keyvalues is not None:
        tags = dict(args.keyvalues)

    resource = acs_client.communication_service.update(args.resource_group_name, args.resource_name, tags)
...
def __delete_communication_service(args):
    ...
    acs_client = __get_communication_management_client()
    acs_client.communication_service.delete(args.resource_group_name, args.resource_name)
...
def __regenerate_key(args):
    ...
    acs_client = __get_communication_management_client()
    key = acs_client.communication_service.regenerate_key(args.resource_group_name, args.resource_name, KeyType(args.type))
    print(key)
